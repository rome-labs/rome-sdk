...
pub fn decode_transaction_from_rlp(rlp: &Rlp) -> ProgramResult<Transaction> {
    ...
    if tx.transaction_type != Some(U64::from(0x7E)) {
...
impl Default for DefaultTxParser {
    fn default() -> Self {
        Self::new()
    }
}

impl DefaultTxParser {
    pub fn new() -> Self {
        Self {
...
impl TxParser for DefaultTxParser {
...
mod test {
    ...
    use crate::indexer::parsers::default_tx_parser::DefaultTxParser;
    ...
    async fn test_register_atomic() {
        ...
        let mut tx_parser = DefaultTxParser::new();
